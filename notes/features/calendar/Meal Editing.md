...
| [[Add Meal Changes (Saved Recipes)]] | ready | the Add Meal layout that edit mode reuses | [[Calendar and Recipes Data Refresh]] |
...
| [[Mobile List View]] | ready | none - cards have no actions | re-review of Steps 2 and 5; [[Calendar and Recipes Data Refresh]] |
...
*[[Calendar and Recipes Data Refresh]] (split from [[Stale Data Issues]]) blocks [[Add Meal Changes (Saved Recipes)]] (decided 2026-09-25). The date picker stories ([[Unified Date Picker Component]] hub) don't depend on it.*
...
2. [[Add Meal Changes (Saved Recipes)]] - after [[Calendar and Recipes Data Refresh]] - so edit mode is not built on the old Add Meal layout (not stated in either note; see open decision 7)
...
7. **Build order.** Should [[Add Meal Changes (Saved Recipes)]] land before edit mode? Should [[Stale Data Issues]] land before any new meal mutations?
   - Partly answered 2026-09-25: [[Add Meal Changes (Saved Recipes)]] and [[Mobile List View]] are blocked on [[Calendar and Recipes Data Refresh]] (split from [[Stale Data Issues]]). Whether edit mode waits for Add Meal Changes is still open.
