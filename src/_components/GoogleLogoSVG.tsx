 ...
 * From Google Sign-In Brand Guidelines: https://developers.google.com/identity/branding-guidelines
 *
 * Guidelines followed:
 * - Logo must be the standard color version on white background
 * - Logo colors must not be changed
 * - Logo size and padding must be preserved
 */
export const GoogleLogoSVG = ({ size = 20 }: { size?: number }) => (
	...
	>
		<path
			d="M19.6 10.2273C19.6 9.51823 19.5364 8.83638 19.4182 8.18182H10V12.05H15.3818C15.15 13.3 14.4455 14.3591 13.3864 15.0682V17.5773H16.6182C18.5091 15.8364 19.6 13.2727 19.6 10.2273Z"
			fill="#4285F4"
		/>
		<path
